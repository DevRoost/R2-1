module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('portals', 'url', { transaction });

      await queryInterface.removeColumn('portals', 'name', { transaction });

      await queryInterface.removeColumn('persistent_data', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('persistent_data', 'data', {
        transaction,
      });

      await queryInterface.removeColumn('dashboards', 'title', { transaction });
      ...
      await queryInterface.dropTable('portals', { transaction });

      await queryInterface.dropTable('persistent_data', { transaction });
