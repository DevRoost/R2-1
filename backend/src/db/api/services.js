...
module.exports = class ServicesDBApi {
  static async create(data, options) {
    ...
    await services.setCategory(data.category || null, {
      transaction,
    });
  ...
  static async bulkImport(data, options) {
    ...
    // Bulk create items
    const services = await db.services.bulkCreate(servicesData, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    const services = await db.services.findOne({ where }, { transaction });
    ...
    output.category = await services.getCategory({
      transaction,
    });
  ...
  static async findAll(filter, options) {
    ...
    if (filter) {
      ...
      if (filter.name) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('services', 'name', filter.name),
        };
      }
      ...
      if (filter.description) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('services', 'description', filter.description),
        };
      }
    ...
    let { rows, count } = options?.countOnly
      ...
      : await db.services.findAndCountAll({
          where,
          include,
          distinct: true,
          limit: limit ? Number(limit) : undefined,
  ...
  static async findAllAutocomplete(query, limit) {
    ...
    if (query) {
      where = {
        [Op.or]: [
          { ['id']: Utils.uuid(query) },
          Utils.ilike('services', 'name', query),
        ],
      };
    }
