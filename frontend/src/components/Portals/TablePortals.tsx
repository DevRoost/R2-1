...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/portals/portalsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePortalsCols';
...
const TableSamplePortals = ({
  ...
  useEffect(() => {
    if (portalsNotify.showNotification) {
      notify(portalsNotify.typeNotification, portalsNotify.textNotification);
    }
  }, [portalsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/portals/portals-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {portals && Array.isArray(portals) && !showGrid && (
        <ListPortals
          portals={portals}
          loading={loading}
...
export default TableSamplePortals;
