    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Services Category</p>
            <CardBox
            ...
            >
                ...
                <table>
                  ...
                  <tbody>
                    {categories.services_category &&
                      Array.isArray(categories.services_category) &&
                      categories.services_category.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!categories?.services_category?.length && (
