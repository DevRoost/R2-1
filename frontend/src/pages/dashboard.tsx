...
const Dashboard = () => {
  ...
  const [persistent_data, setPersistent_data] = React.useState('Loading...');
  const [portals, setPortals] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_PERSISTENT_DATA') && (
          ...
          {hasPermission(currentUser, 'READ_PORTALS') && (
